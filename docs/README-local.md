# Local Coder setup (Docker Compose)

Run the Coder **server** on your machine with Docker, GitHub OAuth, and optional ngrok. For production-style deployment on **AWS EC2 + k3s**, see **[README-aws.md](./README-aws.md)**.

← [Repository overview](../README.md)

---

# DevOps Coder Templates — local development
